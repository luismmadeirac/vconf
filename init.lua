...
_G.pp = function(a, opt)
  print(Config.common.pb.inspect(a, opt))
end
...
_G.pb = lz.put(_G, "pb", "user.common.pb") --- @as pebbles.Pebbles
...
api.nvim_create_autocmd("VimEnter", {
  callback = function()
    -- Winbar disabled (not needed)
    -- require("user.modules.winbar").init()

    -- Buf cleaner disabled temporarily (needs imminent library)
